...
def CreateForecast(df):
	...
	df[df[['Status','Order Type', 'Shipping First Name', 'Shipping Last Name', 'Shipping Address', 'Shipping Postal Code', 'Shipping City', 'Shipping Region']]==""] = np.NaN
	#df = df[['Status','Order Type', 'Shipping First Name', 'Shipping Last Name', 'Shipping Address', 'Shipping Postal Code', 'Shipping City', 'Shipping Region']].fillna(method='ffill')
	temp = df['Item']
	sizeTemp = df['Size']
